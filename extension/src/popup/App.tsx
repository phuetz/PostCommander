...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <main style={{ flex: 1, padding: '16px', overflowY: 'auto' }}>
        {activeTab === 'home' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            >
              <h2
                style={{ margin: '0 0 8px 0', fontSize: '14px', fontWeight: 500, color: '#374151' }}
              >
                Quick Actions
              </h2>
              <button
                    ...
                    try {
                      ...
                      if (results && results[0].result) {
                        ...
                        const response = await fetch(
                          'http://localhost:3001/api/posts/repurpose-url',
                          {
                            method: 'POST',
                            headers: {
        ...
        {activeTab === 'settings' && (
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: '14px', color: '#6b7280' }}>
              Configure your PostCommander API key here.
            </p>
          </div>
        )}
      </main>
      ...
      <footer
        style={{ display: 'flex', borderTop: '1px solid #e5e7eb', backgroundColor: '#ffffff' }}
      >
        <button
