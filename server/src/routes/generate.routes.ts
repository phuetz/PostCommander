...
import {
  handleABTest,
} from '../controllers/ab-testing.controller.js';
import { handleVideoScriptGenerate } from '../controllers/generate.controller.js';
...
router.post('/carousel', requireFeature('carousel'), validate(carouselSchema), handleGenerateCarousel);
router.post('/repurpose', requireFeature('repurpose'), validate(repurposeSchema), handleRepurpose);
router.post('/hashtags', requireFeature('hashtags'), validate(hashtagsSchema), handleResearchHashtags);
