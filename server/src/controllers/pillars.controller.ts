 ...
 * GET /api/pillars
 */
export const handleListPillars = catchAsync(async (req: Request, res: Response): Promise<void> => {
 ...
 * POST /api/pillars
 */
export const handleCreatePillar = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
 ...
 * PUT /api/pillars/:id
 */
export const handleUpdatePillar = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
 ...
 */
export const handleDeletePillar = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
 ...
 */
export const handleListIdeas = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
 ...
 */
export const handleCreateIdea = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
  const pillar = await getPillar(requestUser.id, req.params.id as string);
  if (!pillar) {
    throw new AppError(404, 'Pillar not found');
 ...
 */
export const handleGenerateIdeas = catchAsync(
 ...
 */
export const handleUpdateIdea = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
 ...
 */
export const handleDeleteIdea = catchAsync(async (req: Request, res: Response): Promise<void> => {
  const requestUser = requireRequestUser(req);
 ...
 */
export const handleStrategyOverview = catchAsync(
  async (req: Request, res: Response): Promise<void> => {
    const requestUser = requireRequestUser(req);
